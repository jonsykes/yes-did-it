...
// Mock shared git utilities (keep the agent-output helpers intact)
vi.mock("./shared", async () => {
  const real = await vi.importActual<typeof import("./shared")>("./shared")
  return {
    ...real,
    getGitContext: vi.fn(),
    getBranch: vi.fn(),
...
import { listTodosPage } from "./api-client.js"
